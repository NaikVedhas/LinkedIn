...
const Navbar = () => {
  ...
  //Now we want to get notifications and connections only when we ahve authUser
  ...
  const {mutate:logout} = useMutation({
    ...
    onSuccess:()=>{
      ...
      queryClient.invalidateQueries({queryKey:["authUser"]}); // so it will reftech this and authUser is null we will be redirected to login pages without refreshing
